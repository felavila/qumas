...
Report bugs at [https://github.com/favila/quma/issues](https://github.com/favila/quma/issues).
W
Stambling upon a Bug means encountering different behaviour than the expected/advertised one. When you are reporting a bug, please include the following infromation by filling in [the template](https://github.com/favila/quma/.github/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
quma could always use more documentation, whether as part of the official quma docs, in docstrings, etc.
...
The best way to send feedback is to file an issue at [https://github.com/favila/quma/issues](https://github.com/favila/quma/issues).
...
Here's how to set up `quma` for local development.

1. Fork the `quma` repo on GitHub.
2. Clone your fork locally:

```bash
git clone git@github.com:favila/quma.git
```
...
quma is designed to do one thing, and do that one thing very well.
...
The roadmap located [here](https://github.com/favila/quma/milestones?direction=desc&sort=due_date&state=open)
