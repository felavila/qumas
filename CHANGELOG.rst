...
| This is the first ever release of the **quma** Python Package.
| The package is open source and is part of the **quma** Project.
| The project is hosted in a public repository on github at https://github.com/favila/quma
...
- **CI Pipeline** running on Github Actions at https://github.com/favila/quma/actions
